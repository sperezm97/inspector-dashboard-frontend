...
const ToastAnimations = () => {
  ...
  const notifyFlip = () =>
    toast.warning(<WarningToast />, { transition: Flip, hideProgressBar: true })
  const notifyZoom = () =>
    toast.error(<ErrorToast />, { transition: Zoom, hideProgressBar: true })
  const notifySlide = () =>
    toast.info(<InfoToast />, { transition: Slide, hideProgressBar: true })
