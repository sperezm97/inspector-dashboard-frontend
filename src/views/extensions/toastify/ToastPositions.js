...
const ToastPositions = () => {
  ...
  const notifyTopCenter = () =>
    toast.info(<InfoToast title="Top Center!" />, {
      position: toast.POSITION.TOP_CENTER,
      hideProgressBar: true,
    })
  const notifyTopRight = () =>
    toast.info(<InfoToast title="This Right!" />, {
      position: toast.POSITION.TOP_RIGHT,
      hideProgressBar: true,
    })

  const notifyBottomLeft = () =>
    toast.info(<InfoToast title="Bottom Left!" />, {
      position: toast.POSITION.BOTTOM_LEFT,
      hideProgressBar: true,
    })
  const notifyBottomCenter = () =>
    toast.info(<InfoToast title="Bottom Center!" />, {
