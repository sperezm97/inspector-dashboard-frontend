              ...
              <ul className="list-inline m-0">
                <li className="list-inline-item mr-1">
                  <span
                    ...
                    onClick={() =>
                      dispatch(
                        updateMails([mail.id], { isStarred: !mail.isStarred }),
                      )
                    }
                  >
                    <Star
                  ...
                  <UncontrolledDropdown>
                    ...
                    <DropdownMenu right>
                      <DropdownItem
                        ...
                        href="/"
                        onClick={(e) =>
                          handleLabelsUpdate(e, 'personal', [mail.id])
                        }
                        className="d-flex align-items-center"
                      >
                      ...
                      <DropdownItem
                        ...
                        href="/"
                        onClick={(e) =>
                          handleLabelsUpdate(e, 'company', [mail.id])
                        }
                        className="d-flex align-items-center"
                      >
                      ...
                      <DropdownItem
                        ...
                        href="/"
                        onClick={(e) =>
                          handleLabelsUpdate(e, 'important', [mail.id])
                        }
                        className="d-flex align-items-center"
                      >
                      ...
                      <DropdownItem
                        ...
                        href="/"
                        onClick={(e) =>
                          handleLabelsUpdate(e, 'private', [mail.id])
                        }
                        className="d-flex align-items-center"
                      >
