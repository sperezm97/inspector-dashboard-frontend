...
// ** GET Mails
export const getMails = (params) => (dispatch) =>
  axios.get('/apps/email/emails', { params }).then((res) => {
    dispatch({ type: 'GET_MAILS', data: res.data, params })
  })

// ** UPDATE Mails
export const updateMails = (emailIds, dataToUpdate) => (dispatch, getState) =>
  axios
...
// ** Update Mail Label
export const updateMailLabel = (emailIds, label) => (dispatch, getState) =>
  axios
...
// ** GET Next/Prev mail
export const paginateMail = (dir, emailId) => (dispatch) =>
  axios
...
// ** SELECT All Mails
export const selectAllMail = (val) => (dispatch) =>
  dispatch({ type: 'SELECT_ALL_MAIL', val })

// ** RESET Selected Mails
export const resetSelectedMail = () => (dispatch) =>
