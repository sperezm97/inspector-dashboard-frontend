      ...
      <Row>
        ...
        <Col md="6" sm="12">
          <Card title="Interval Example" code={carouselInterval}>
            <CardText>
              Use <code>Interval</code> prop to set interval between slides.
              default interval is <strong>5000</strong>.
            </CardText>
            <CarouselInterval />
          </Card>
        </Col>
        <Col md="6" sm="12">
          <Card title="Keyboard Example" code={carouselKeyboard}>
            <CardText>
              Use <code>Keyboard</code> prop to control carousel with keyboard
