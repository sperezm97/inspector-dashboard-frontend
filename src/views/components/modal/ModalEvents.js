    ...
    <div className="demo-inline-spacing">
      <div className="on-opened-modal">
        ...
        >
          ...
          <ModalBody>
            Donut chocolate halvah I love caramels. Dessert croissant I love
            icing I love dragée candy canes chocolate bar. Oat cake lollipop I
            love cake chocolate bar jelly sweet. I love cotton candy oat cake
            jelly.
          </ModalBody>
          <ModalFooter>
            <Button
      ...
      <div className="on-closed-modal">
        ...
        <Modal
          ...
          className="modal-dialog-centered"
        >
          <ModalHeader toggle={() => setModalClosed(!modalClosed)}>
            Basic Modal
          </ModalHeader>
          <ModalBody>
            Donut chocolate halvah I love caramels. Dessert croissant I love
