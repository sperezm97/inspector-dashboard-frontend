      ...
      <Row className="match-height">
        ...
        <Col lg="6" md="12">
          <Card title="Disabled Items" code={listGroupDisabled}>
            <CardText>
              Add <code>disabled</code> prop to a<code>list-group-item</code> to
              gray it out to appear disabled.
            </CardText>
            <ListGroupDisabled />
          </Card>
        </Col>
        ...
        <Col lg="6" md="12">
          <Card title="Tags List Group" code={listGroupTag}>
            <CardText>
              Use <code>tag</code> prop with <code>ListGroupItem</code> tag to
              change item's tag. You can use <code>active</code> prop with{' '}
              <code>ListGroupItem</code> tag to show an item as active. Use
        ...
        <Col lg="6" md="12">
          <Card title="Contextual List Group" code={listGroupContextual}>
            <CardText>
              Use <code>color</code> prop with <code>ListGroupItem</code> to
              create a contextual list.
            </CardText>
            <ListGroupContextual />
          </Card>
        </Col>
        ...
        <Col lg="6" md="12">
          <Card title="Flush List Group" code={listGroupFlush}>
            <CardText>
              Use <code>flush</code> prop with <code>ListGroup</code> tag to
