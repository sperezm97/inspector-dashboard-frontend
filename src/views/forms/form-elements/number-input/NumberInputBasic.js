...
const NumberInputBasic = () => {
  ...
  return (
    <Card>
      ...
      <CardBody>
        <CardText>
          Number Input is used for incrementing or decrementing a numerical
          value within a range of a minimum and maximum number, with optional
          step value.
        </CardText>
        ...
        <div className="mt-2">
          ...
          <Alert className="mb-0" color="success">
            <div className="alert-body">
              <span>
                The ArrowUp and ArrowDown keys can be used to increment or
                decrement the value.{' '}
              </span>
            </div>
          </Alert>
