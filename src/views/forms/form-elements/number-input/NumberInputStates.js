...
const NumberInputStates = () => (
  <Card>
    ...
    <CardBody>
      <CardText>
        Setting the prop <code>disabled</code> places the component in a
        disabled, non-interactive state. The <code>readonly</code>
        prop places the component in a readonly state (focusable, but the value
