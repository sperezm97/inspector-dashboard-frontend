...
const NumberInputCustomIcons = () => (
  <Card>
    ...
    <CardBody>
      <CardText>
        Use props <code>upIcon</code> or <code>downIcon</code> to change{' '}
        <code>increment</code> and <code>decrement</code> icons.
      </CardText>
      <Row>
        ...
        <Col md="6">
          <NumberInput
            downIcon={<ChevronLeft size={14} />}
            upIcon={<ChevronRight size={14} />}
          />
        </Col>
      </Row>
    </CardBody>
