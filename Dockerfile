...
ARG REACT_APP_API_CEDULA
ARG REACT_APP_API_CEDULA_KEY
...
ARG REACT_APP_API_CEDULA ${REACT_APP_API_CEDULA:-http://localhost}
ARG REACT_APP_API_CEDULA_KEY ${REACT_APP_API_CEDULA_KEY}
